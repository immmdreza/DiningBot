...
MEAL_FA_TO_EN = {"ناهار": "lunch", "شام": "dinner", "سحری": "sahari", "افطار": "eftari"}

MEAL_EN_TO_FA = {"lunch": "ناهار", "dinner": "شام", "sahari": "سحری", "eftari": "افطار"}
...
MAIN_MENU_CHOICES = [[FORGET_CODE_MENU_LABEL, RESERVE_MENU_LABEL]]
BACK_TO_MAIN_MENU_CHOICES = [[BACK_TO_MAIN_MENU_LABEL]]
